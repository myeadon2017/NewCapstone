  ...
  <div class="container-fluid">
	...
	<div class="container">
		...
		<a type="button" class="btn btn-success"
			href="/confirmation/${user.getId()}">Confirm Purchase</a>
		</div>
	</div>
	<div class="container">
		<table class="table table-striped">
			...
			<tbody>
					<tr>
						<td>${user.getShippingStreetAddress1()}</td>
						<td>${user.getShippingStreetAddress2()}</td>
						<td>${user.getShippingCity()}</td>
						<td>${user.getShippingState()}</td>
						<td>${user.getShippingZipcode()}</td>
			</tbody>
		</table>
	</div>
	<div class="container">
		<table class="table table-striped">
			...
			<tbody>
					<tr>
						<td>${user.getBillingStreetAddress1()}</td>
						<td>${user.getBillingStreetAddress2()}</td>
						<td>${user.getBillingCity()}</td>
						<td>${user.getBillingState()}</td>
						<td>${user.getBillingZipcode()}</td>
			</tbody>
		</table>
	</div>
